...
;(function(global,$){
	 ...
	 */
	 var cssMap={
		...
		'.toast-message--info':'{border-color:#EBEEF5;background-color:#909399;}',
		'.toast-message--info .toast-icon':'{margin-right:18px;}',
		'.toast-message--info .toast-message__content':'{color:#F8F8FF;}',
		'.toast-icon--info:before':'{content:"✔";color:#909399;}',
		'.toast-icon--info:after':'{display:block;position:absolute;content:"";width:20px;height:20px;line-height:20px;background:#F8F8FF;left:-5px;top:-3px;border-radius:50%;text-align:center;z-index:-1;}',
